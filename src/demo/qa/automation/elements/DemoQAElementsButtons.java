...
public class DemoQAElementsButtons {
	...
	public static void main(String[] args) throws InterruptedException, IOException, WebDriverException {
		...
		// let us click on button 'Links'
		WebElement element = driver.findElement(By.xpath("//li[contains(@class, 'btn') and contains(span, 'Links')]"));
		js.executeScript("arguments[0].scrollIntoView(true);", element);
		element.click();
		Thread.sleep(2000);

		System.out.println("first tab : " + driver.getCurrentUrl() + " " + driver.getTitle());

		// when link is opened driver switches to some other tab we need to come back to
		// first tab
		String first_tab = driver.getWindowHandle();

		// let us click on link with link text 'Home'
		element = driver.findElement(By.linkText("Home"));
		js.executeScript("arguments[0].scrollIntoView(true);", element);
		element.click();
		System.out.println("second tab : " + driver.getCurrentUrl() + " " + driver.getTitle());
		Thread.sleep(2000);

		driver.switchTo().window(first_tab);
		Thread.sleep(2000);

		// let us click on link with link text 'Home4Wnrh'
		element = driver.findElement(By.xpath("//a[@id='dynamicLink']"));
		js.executeScript("arguments[0].scrollIntoView(true);", element);
		element.click();
		System.out.println("third tab : " + driver.getCurrentUrl() + " " + driver.getTitle());
		Thread.sleep(2000);

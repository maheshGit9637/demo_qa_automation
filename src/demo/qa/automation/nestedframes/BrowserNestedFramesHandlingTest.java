package demo.qa.automation.nestedframes;
...
public class BrowserNestedFramesHandlingTest {
	...
	public static void main(String[] args) throws InterruptedException, IOException, WebDriverException {
		...
		System.out.println("frame2 text content : "
				+ driver.findElement(By.xpath("//p[contains(text(),'Child Iframe')]")).getText());
		...
		System.out.println("content on base page : " + driver.findElement(By.tagName("h1")).getText());
